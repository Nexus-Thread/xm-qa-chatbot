...
class SubmitTeamDataUseCase:
    ...
    def execute(self, command: SubmissionCommand) -> Submission:
        ...
        merged_coverage, merged_overall = self._merge_with_existing(command)
    ...
    def _merge_with_existing(
    ...
    ) -> tuple[TestCoverageMetrics | None, int | None]:
        ...
        if not existing_submissions:
            return command.test_coverage, command.overall_test_cases
        ...
        return merged_coverage, merged_overall
