...
def build_default_registry() -> StreamRegistry:
    ...
    projects = (
        Project(id="affiliate", name="Affiliate", business_stream_id=StreamId("affiliates")),
        Project(id="bridge", name="Bridge", business_stream_id=StreamId("backbone_bridge")),
        Project(id="jthales", name="JThales", business_stream_id=StreamId("backbone_platform")),
        Project(
        ...
        Project(id="jtools", name="JTools", business_stream_id=StreamId("backbone_platform")),
        Project(
            id="data_access_layer",
            name="Data Access Layer (DAL)",
            business_stream_id=StreamId("backbone_platform"),
        ),
        Project(id="metaproxy", name="MetaProxy", business_stream_id=StreamId("backbone_trading")),
        Project(id="plugins", name="Plugins", business_stream_id=StreamId("backbone_trading")),
        Project(id="tsda", name="TSDA", business_stream_id=StreamId("backbone_trading")),
        Project(id="horn", name="HORN", business_stream_id=StreamId("backbone_trading")),
        Project(
        ...
        Project(id="education", name="Education", business_stream_id=StreamId("client_engagement")),
        Project(id="client_support", name="Client Support", business_stream_id=StreamId("client_journey")),
        Project(
            id="client_authentication",
            name="Client Authentication",
            business_stream_id=StreamId("client_journey"),
        ),
        Project(id="client_trading", name="Client Trading", business_stream_id=StreamId("client_journey")),
        Project(
        ...
        Project(id="payments", name="Payments", business_stream_id=StreamId("funding")),
        Project(id="withdrawals", name="Withdrawals", business_stream_id=StreamId("funding")),
        Project(id="kyc", name="KYC", business_stream_id=StreamId("internal_systems")),
        Project(id="scc", name="SCC", business_stream_id=StreamId("internal_systems")),
        Project(id="crm", name="CRM", business_stream_id=StreamId("internal_systems")),
        Project(
        ...
        Project(id="angular_core_web", name="Angular Core Web", business_stream_id=StreamId("www_cfa")),
        Project(id="angular_www", name="Angular WWW", business_stream_id=StreamId("www_cfa")),
    )
